...
version 12.0
	...
	qui replace double `s' = `s' / sqrt((exp(lngamma(1/2))^2*(1+3*`l'^2)*exp(lngamma(3/`p'))-16^(1/`p')*`l'^2*(exp(lngamma(1/2+1/`p')))^2*exp(lngamma(1/`p')))/(exp(lngamma(1/2))^2*exp(lngamma(1/`p'))))
