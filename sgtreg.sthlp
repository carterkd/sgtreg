...
{phang}
{opt qinf:inite} specifies that the distribution that should be used should be the limit of the skewed generalized t distribution as the parameter q becomes arbitrary large (i.e. the skewed generalized error distribution)
